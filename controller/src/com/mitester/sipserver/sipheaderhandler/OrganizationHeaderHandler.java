...
public class OrganizationHeaderHandler {
	...
	public static OrganizationHeader createOrganizationHeader(Header headerNew)
		...
		for (Param objParam : param) {
			LOGGER
			        .warning("As Per RFC RFC 3261 Organization Header does not have any parameters. Hence Ignoring the parameters\t"
			                + "Parameter Name: "
			                + objParam.getName()
			                + "\t"
		...
		// 
		// LOGGER
		// .warning("As Per RFC 3261 Organization Header does not have any parameters. Hence Ignoring the parameters\t");
		return org;
	}
