...
public class INVITERequestHandler {
	private static final Logger LOGGER = MiTesterLog
			.getLogger(INVITERequestHandler.class.getName());
	 ...
	 */
	public static Request createINVITERequest(String dialog)
			throws NullPointerException, java.text.ParseException,
			InvalidArgumentException, PeerUnavailableException {
		LOGGER.info("Generation of INVITE Request is started");
		Request request;
		...
		LOGGER.info("Generation of INVITE Request is ended");
		return request;
	}
