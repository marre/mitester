...
public class INVITERequestHandler {
	 ...
	 */
	public static Request createINVITERequest(String dialog) throws NullPointerException,
		...
		callid = MessageHandlerHelper.createCallIdHeader(Integer
			...
			SIPMessage sipMsg = ProcessSIPMessage.getSIPMessage(dialog, Request.INVITE,
			        SERVER_REQUEST);
